...
! set passed variables to public
  ...
  public :: hydrotable_format, hydrotype, coeff_format, dda_lut
...
!                                                          certain instruments. Set to greater than zero to use  
  ...
  logical :: allsky_gfdl,allsky_verbose,dda_lut
  integer(i_kind) :: cloud_mask_option
  integer(i_kind) :: nsigradjac, nvarjac
  character(len=20) :: hydrotable_format, coeff_format
...
!$$$ end documentation block
    ...
    coeff_format = 'binary'      ! format of CRTM coefficient files
    ...
    dda_lut = .false.     ! .true.= use CRTM DDA cloud LUT
