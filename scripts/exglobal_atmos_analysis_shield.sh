...
ANAVINFO=${ANAVINFO:-${FIXshield}/global_anavinfo.l${LEVS}.txt}
...
HYBENSINFO=${HYBENSINFO:-${FIXshield}/global_hybens_info.l${LEVS}.txt}
...
&SETUP
  ...
  use_pbl=.false.,use_compress=.true.,nsig_ext=23,gpstop=50.,
